<script lang="ts">
	...
	let options = $state(['Option 1', 'Option 2', 'Option 3']);
	let newOption = $state('');
...
<div class="container" onclick={reset} onkeydown={reset} role="button" tabindex="0">
	...
	{:else}
		<div class="options">
			...
			<button class="spin-button" onclick={startSpin} disabled={options.length < 2}>
				Spin the wheel
			</button>
		</div>
	{/if}
